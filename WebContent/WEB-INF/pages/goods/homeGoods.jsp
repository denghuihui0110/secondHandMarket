...
<div ng-controller="sidebarController" class="sidebar stark-components ng-scope">
    ...
    <div class="info">
        <a href="https://jq.qq.com/?_wv=1027&k=5GvG9Hi">关于我们</a><em>-</em>
        <a href="http://wpa.qq.com/msgrd?v=3&uin=1820998409&site=qq&menu=yes">联系我们</a>
        <p>©2020 邓皇皇家工作室</p>
    </div>
</div>
<!--
                    ...
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到【农大自己的】校园二手市场。临近毕业季的</p>
                                <p class="text3">你，是否有太多的闲置与校友分享，为了追求更好的校园服</p>
                                <p class="text4">务，我们打造了一个全新的校园平台——<span>农大自己的校园二手市场</p>
                                <p class="text5">这里有更多的闲置分享，更自由的校园话题讨论，你想要的，都在这里。</p>
                                <p class="text6">加入农大自己的校园二手市场，你的大学，应更精彩。</p>
                            </ul>
                          <!--   <div class="logoimg">
