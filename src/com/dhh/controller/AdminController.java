...
import com.dhh.util.GoodsGrid;
import com.dhh.util.OrdersGrid;
import com.dhh.util.PurseGrid;
import com.dhh.util.UserGrid;
...
public class AdminController {
	...
	public String index(HttpServletRequest request, Admin admins) {
		Admin myadmin = null;
		if(null != admins.getPhone()) {
			myadmin = adminService.findAdmin(admins.getPhone(), admins.getPassword());
			if (myadmin != null) {
				request.getSession().setAttribute("admin", myadmin);
				return "/admin/index";
			}
			myadmin = adminService.findAdminByName(admins.getPhone()+"", admins.getPassword());
			if (myadmin != null) {
				request.getSession().setAttribute("admin", myadmin);
				return "/admin/index";
			}
	...
	/*********************************************************
	 * 商品管理 1.查找所有商品 2.查看商品 3.修改商品 4.删除商品 5.查询商品 
	 * 
	 **********************************************************/
	...
	/*********************************************************
	 * 钱包管理 1.查找所有钱包 2.查看钱包 3.修改钱包 4.删除钱包 5.查询钱包 
	 * 
	 **********************************************************/
